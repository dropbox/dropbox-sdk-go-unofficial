...
class GoClientBackend(CodeBackend):
    ...
    def _generate_request(self, namespace, route):
        ...
        if not is_void_type(route.arg_data_type):
            out('dbx.Config.TryLog(LogDebug, "arg: %v", arg)')
        ...
        out('dbx.Config.TryLog(LogInfo, "req: %v", req)')
    ...
    def _generate_post(self):
        ...
        out('dbx.Config.TryLog(LogInfo, "resp: %v", resp)')
    ...
    def _generate_response(self, route):
        ...
        out('dbx.Config.TryLog(LogDebug, "body: %v", body)')
